...
class Services extends Component {
    ...
    return (
        <div>
            <Navbar />
            <div className="  ">
            <h1 className="px-20 font-sans text-3xl font-bold text-gray-600">Services</h1>
            <svg xmlns="http://www.w3.org/2000/svg" width="100vw" viewBox="0 0 1994.315 2524.346">
