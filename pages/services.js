...
class Services extends Component {
    ...
    return (
        <div>
            <Navbar />
            <div className="">
            <span className="title font-sans text-6xl font-bold text-pink-500 mx-auto absolute top-32 left-40"> Services</span>
            <svg xmlns="http://www.w3.org/2000/svg" width="100vw" viewBox="0 0 1994.315 2524.346" className="services-svg absolute top-48">
